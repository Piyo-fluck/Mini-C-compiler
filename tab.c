...
/* itab 荳ｭ縺ｫ id 繧呈爾縺暦ｼ瑚ｦ九▽縺九ｌ縺ｰ縺昴�繧､繝ｳ繝�ャ繧ｯ繧ｹ繧定ｿ斐☆��
   隕九▽縺九ｉ縺ｪ縺代ｌ縺ｰ itab_FAIL 繧定ｿ斐☆ */
{
  int j;
  int index = itab_FAIL;
  assert(t!=NULL);
...
/* itab 荳ｭ縺ｫ id 繧堤匳骭ｲ縺�, 縺昴�繧､繝ｳ繝�ャ繧ｯ繧ｹ繧定ｿ斐☆. 
   繧ゅ＠譌｢縺ｫ id 縺檎匳骭ｲ縺輔ｌ縺ｦ縺�ｌ縺ｰ itab_FAIL 繧定ｿ斐☆ */
{
  int i;
  int new_i;
  assert(t!=NULL);
