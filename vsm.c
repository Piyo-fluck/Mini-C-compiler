...
/* 蜀�Κ險俶� */
static int PC = 0;  /* 繝励Ο繧ｰ繝ｩ繝�繧ｫ繧ｦ繝ｳ繧ｿ */
static int SP = -1;  /* 繧ｹ繧ｿ繝�け繝昴う繝ｳ繧ｿ */
static int B[2] = {0, 0};  /* 繝吶�繧ｹ繝ｬ繧ｸ繧ｹ繧ｿ (0: global逕ｨ, 1: local逕ｨ) */
static int M[MEM_MAXSIZE];  /* 繝｡繝｢繝ｪ繝ｼ/繧ｹ繧ｿ繝�け */
static int max_SP = 0;  /* 縺薙ｌ縺ｾ縺ｧ縺ｫ繧｢繧ｯ繧ｻ繧ｹ縺励◆譛螟ｧ SP */
...
static void address_error(char *mem, int a)
/* 繝｡繝｢繝ｪ繝ｼ繧｢繧ｯ繧ｻ繧ｹ縺ｮ繧｢繝峨Ξ繧ｹ縺ｮ繧ｨ繝ｩ繝ｼ */
{
