...
#define code_INSN_MNEMONIC_MAXLEN 7 /* 蜻ｽ莉､縺ｮ蜷榊燕縺ｮ譛螟ｧ髟ｷ */
static char insn_mnemonic_[opcode_MAX_][code_INSN_MNEMONIC_MAXLEN+1]; /* 蜻ｽ莉､蜷� */
static int insn_n_operands_[opcode_MAX_]; /* 繧ｪ繝壹Λ繝ｳ繝画焚 */
